...
const mingas = [
  ...
  },
  {
    ...
    image: '/logos/SAN%20PANTALEON.JPG.jpeg',
  ...
  },
  {
    ...
    image: '/logos/LA%20PODEROSA.jpg.jpeg',
  ...
  },
  {
    ...
    image: '/logos/PIEDRABUENARTE.png',
...
app.innerHTML = `
  ...
  <main id="inicio">
    <section class="hero">
      ...
      <div class="hero-brand-lockup"><img src="/logos/logo%20minga%20blanco.png" alt="Mingas Urbanas"></div>
    ...
    <div class="closing-art" aria-hidden="true"><img src="/logos/logo-rover-blanco.svg" alt="" onerror="this.hidden=true"></div>
  ...
  <footer class="site-footer"><div class="footer-logo footer-scouts"><img src="/logos/zona%20celeste.png" alt="Scouts de Argentina Zona 2"></div><div class="footer-center"><p class="footer-title">MINGAS URBANAS<br><span>— ZONA 2 —</span></p><p class="footer-motto">“Nadie se salva solo. Toda salida para construir comunidad es colectiva.”</p></div><div class="footer-logo footer-anniversary"><img src="/logos/30%20a%C3%B1os%20SAAC.png" alt="30 años Scouts de Argentina"></div></footer>
`;
